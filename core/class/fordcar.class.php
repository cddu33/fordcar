  ...
  /* Non obligatoire mais permet de modifier l'affichage du widget si vous en avez besoin */
	...
	/*
		...
		if (version_compare(jeedom::version(), '4.4.0') >= 0) {
			$template = 'fordcar_dashboard_v44';
		}
